...
var ImgCrop = forwardRef(function (props, ref) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    reader.addEventListener('load', function () { return typeof reader.result === 'string' && setImage(reader.result); });
    ...
    var onOk = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var canvas, ctx, imgSource, _a, cropWidth, cropHeight, cropX, cropY, imgWidth, imgHeight, angle, sine, cosine, squareWidth, squareHeight, squareHalfWidth, squareHalfHeight, imgX, imgY, imgData, _b, type, name, uid, onBlob;
        return __generator(this, function (_c) {
            ...
            onBlob = function (blob) { return __awaiter(void 0, void 0, void 0, function () {
                var newFile, res, passedFile, err_1;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (res === true)
                                return [2 /*return*/, resolveRef.current(newFile)];
                            if (res === false)
                                return [2 /*return*/, rejectRef.current(new Error('not upload'))];
                            if (!(res && res instanceof Promise)) return [3 /*break*/, 4];
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, res];
                        case 2:
                            ...
                            if (passedFile instanceof File || passedFile instanceof Blob) {
                                return [2 /*return*/, resolveRef.current(passedFile)];
                            }
